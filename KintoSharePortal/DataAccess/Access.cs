...
namespace KintoSharePortal.DataAccess
{
    public class Access
    {
        ...
        //User
        public List<UserModel> ShowUser(UserModel UM)
        {
            List<UserModel> listUser = null;
            //using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionStringShowUser"].ConnectionString))
