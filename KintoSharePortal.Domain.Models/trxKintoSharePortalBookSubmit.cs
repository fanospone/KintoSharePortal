...
{
    public class trxKintoSharePortalBookSubmit : BaseClass
    {
        public trxKintoSharePortalBookSubmit()
        {
            this.ErrorType = 0;
            this.ErrorMessage = null;
        }
        public trxKintoSharePortalBookSubmit(int errorType, string errorMessage)
        {
